...
//This template function is needed for AOD when pfNoPileUpCandidates are used, which have modified keys.
//It's not working for packedCandidate (thus for miniAOD)
template <class T, class U>

...
def LoadEgmIdSequence(process, dataFormat):
    ...
    if dataFormat== DataFormat.AOD:
        ...
        process.egmPhotonIDSequence = cms.Sequence(process.egmPhotonIsolationAODSequence * process.photonIDValueMapProducer * process.photonMVAValueMapProducer * process.egmPhotonIDs * process.photonRegressionValueMapProducer )

...
from PhysicsTools.TagAndProbe.treeMakerOptions_pileup_Down_cfi import *
...
process.ele_sequence = cms.Sequence(
    ...
    process.goodElectronsPROBETrigWP80 + 
    process.goodElectronsPROBETrigWP90 + 
    process.goodElectronsTAGTrigWP80 +
    process.goodElectronsTAGTrigWP90 +
...
process.GsfElectronToRECO = cms.EDAnalyzer("TagProbeFitTreeProducer",
                                           ...
                                           arbitration   = cms.string("Random2"),
                                           flags         = cms.PSet(passingTrigWP80   = cms.InputTag("goodElectronsPROBETrigWP80"),
                                                                    passingTrigWP90  = cms.InputTag("goodElectronsPROBETrigWP90"),
                                                                    ),                                               
